...
export default class ListActivitiesController {
  constructor(
    private readonly listActivitiesAsTeacher: ListActivitiesAsTeacher,
    private readonly listActivitiesAsStudent: ListActivitiesAsStudent,
    private readonly listAllTeacherActivities: ListAllTeacherActivities,
    private readonly listAllActivities: ListAllActivities,
  ) { }
